...
#include "FATRAS/Simulation/detail/EnergyLoss.h"
// ACTS includes
...
// set configuration
void Fatras::MaterialInteractionEngine::setConfigruation(const MaterialInteractionEngine::Config& miConfig)
{
...
///** neutral extrapolation */
//Acts::ExtrapolationCode Fatras::MaterialInteractionEngine::processMaterialOnLayer(Acts::ExCellNeutral& eCell,
//                                                                                  Acts::PropDirection dir,
...
//
///** charged extrapolation */
//Acts::ExtrapolationCode Fatras::MaterialInteractionEngine::processMaterialOnLayer(Acts::ExCellCharged& eCell,
//										                                          Acts::PropDirection dir,
//										                                          float& mFraction) const
//{
...
//const Acts::NeutralParameters* Fatras::MaterialInteractionEngine::updateTrackParameters(const Acts::NeutralParameters& parameters,
//											                                            Acts::ExCellNeutral&,
//											                                            Acts::PropDirection,
//											                                            double,
//											                                            double,
...
//
///** charged extrapolation */
//const Acts::TrackParameters* Fatras::MaterialInteractionEngine::updateTrackParameters(const Acts::TrackParameters& parameters,
...
//  double m    = m_config.particleMasses.mass[eCell.pHypothesis];
...
//  if (materialProperties && (m_config.energyLossSampler || m_config.doMultipleScattering)) {    
...
//        
//    if ( m_config.doEnergyLoss ) {
//      
//      // smeared/presampled energy loss
//      Acts::EnergyLoss eloss = (eCell.pHypothesis==Acts::electron && m_config.elEnergyLossSampler) ? 
//                                m_config.elEnergyLossSampler->energyLoss(*materialProperties, p, dX0/thicknessInX0, dir, eCell.pHypothesis) : 
//                                m_config.energyLossSampler->energyLoss(*materialProperties, p, dX0/thicknessInX0, dir, eCell.pHypothesis);
//     
//      if (eCell.pHypothesis==Acts::electron && m_config.recordBremPhoton) {
//	    // ionization update first @TODO check with sharke what about the minimumMomentum ?
//        double newP = E+eloss.meanIoni()>m ? sqrt((E+eloss.meanIoni())*(E+eloss.meanIoni())-m*m) : 0.5*m_config.minimumMomentum;
//        uParameters[Acts::eQOP] = parameters.charge()/newP;
//        // radiation
//        if (newP>m_config.minimumMomentum)
...
//        double newP = E+eloss.deltaE()>m ? sqrt((E+eloss.deltaE())*(E+eloss.deltaE())-m*m) : 0.5*m_config.minimumMomentum;
//        uParameters[Acts::eQOP] = parameters.charge()/newP;
//      }
//      
...
//      double simTheta = m_config.multipleScatteringSampler->simTheta(*materialProperties, p, dX0/thicknessInX0, eCell.pHypothesis);
...
//                               m_config.multipleScatteringSampler->simTheta(*materialProperties, p, dX0/thicknessInX0, eCell.pHypothesis));
//     
//    }
//    
