...
public:
  ...
  EnergyLoss(double deltaE,
             double sigmaDeltaE,
             double meanIonization,
             double sigmaIonization,
             double meanRadiation,
  ...
  /// will be taken to calculate the energy loss
  void
  update(EnergyLoss& eLoss, bool mpv = false);
...
inline double
EnergyLoss::meanIonization() const
{
  return m_meanIonization;
}

inline double
EnergyLoss::sigmaIonization() const
{
  return m_sigmaIonization;
}

inline double
EnergyLoss::meanRadiation() const
{
  return m_meanRadiation;
}

inline double
EnergyLoss::sigmaRadiation() const
{
  return m_sigmaRadiation;
}
...
inline void
EnergyLoss::update(double meanIonization,
                   double sigmaIonization,
                   double meanRadiation,
                   double sigmaRadiation,
                   bool   mpv)
