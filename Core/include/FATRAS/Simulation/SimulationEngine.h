    ...
    class SimulationEngine {
      public :
        ...
        struct Config {
            ...
            std::shared_ptr<IExtrapolationEngine> transportEngine; //!< the transport engine
        ...
        std::pair<Acts::ParticleProperties, std::vector<Acts::InteractionVertex> simulate(const Acts::ParticleProperties& pProperties) const;
