...
void
Fatras::ElectronEnergyLossSampler::setConfiguration(
    const Fatras::ElectronEnergyLossSampler::Config& elConfig)
{
...
void
Fatras::ElectronEnergyLossSampler::setLogger(
...
Fatras::EnergyLoss
Fatras::ElectronEnergyLossSampler::energyLoss(
    ...
    Acts::ParticleType) const
{
  ...
  double simulatedDeltaE = fabs(MOP)
