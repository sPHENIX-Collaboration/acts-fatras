 ...
 public:
  ...
  ElectronEnergyLossSampler(
      ...
      std::unique_ptr<Acts::Logger> logger = Acts::getDefaultLogger(
          "ElectronEnergyLossSampler", Acts::Logging::INFO));
   ...
   * energy loss */
  Fatras::EnergyLoss energyLoss(
      const Acts::MaterialProperties& mat, double momentum,
      double pathcorrection, Acts::PropDirection dir = Acts::alongMomentum,
...
inline double ElectronEnergyLossSampler::dEdX(const Acts::MaterialProperties&,
                                              double,
